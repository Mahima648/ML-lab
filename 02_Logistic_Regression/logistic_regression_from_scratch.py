...
# 2. Gradient Calculation (Matrix Form)
...
theta_hat = gradient_descent(X_train_scaled, y_train, alpha=0.1, n_iterations=300)
...
plt.hist(test_probabilities[y_test == 0], bins=20, alpha=0.7, color='red', label='Class 0 (Malignant)')
plt.hist(test_probabilities[y_test == 1], bins=20, alpha=0.7, color='blue', label='Class 1 (Benign)')
